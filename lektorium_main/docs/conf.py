...
"""
lektorium_main documentation build configuration file.
...
project = 'lektorium_main'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'lektorium_main'
...
#
# html_title = 'lektorium_main v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'lektorium_main'),
                os.path.join(root_path, 'lektorium_main/migrations')])
