#!/usr/bin/env python
"""
Package metadata for lektorium_main.
"""
import os
import re
import sys
...
VERSION = get_version('lektorium_main', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/lektorium_main',
    packages=find_packages(
        include=['lektorium_main', 'lektorium_main.*'],
        exclude=["*tests"],
    ),
